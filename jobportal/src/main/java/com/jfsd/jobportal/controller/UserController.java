...
public class UserController {
    ...
    public ResponseEntity<Application> updateApplicationStatus(@PathVariable int id, @RequestBody Map<String, String> status) {
        Application application = applicationRepository.findById(id)
                .orElseThrow(() -> new ResourceNotFoundException("Application not found with id: " + id));

        application.setStatus(status.get("status"));  // Set the new status from the request body
